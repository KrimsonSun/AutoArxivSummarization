...
control) is $\Delta F_1 = +0.153$ strict-LLM, $95\%$~CI
$[+0.058,+0.265]$ on $n=13$ paired papers; $\Delta F_1 = +0.150$
DeBERTa-NLI, CI~$[+0.061,+0.254]$. We sketch the three fixes here and
...
recovers the $+0.15$ $F_1$ result above. Crucially, the same prompt
...
same-prompt single-LLM control (B6 in this paper) by $+0.15$ $F_1$
under both decoupled judges on $n=13$ paired papers. The negative
